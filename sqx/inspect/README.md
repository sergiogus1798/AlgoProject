# sqx/inspect — read what SQX has, change nothing
...
|---|---|---|
| `dump_project.py` | Render one project as a Markdown pipeline map | `python3 -m sqx.inspect.dump_project <PROJECT> -o /tmp/<PROJECT>.md` |
